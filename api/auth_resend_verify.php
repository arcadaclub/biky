...
if (nr_wp_login_environment()) {
    nr_json_response([
        'ok' => false,
        'error' => 'E-Mail-Bestätigung erfolgt über die Club-Website (WordPress).',
    ], 400);
    exit;
}
...
try {
    ...
    nr_auth_resend_verification(nr_db(), $email);
    nr_json_response([
        'ok' => true,
        'message' => 'Wenn die Adresse ein unbestätigtes Konto hat, wurde ein neuer Bestätigungslink versendet.',
    ]);
} catch (Throwable $e) {
